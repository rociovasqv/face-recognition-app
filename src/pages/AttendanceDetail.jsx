...
const AttendanceDetail = () =>
    {
        ...
        if (!aDetail) 
          ...
          return (
            <div>
                <h2>Detalles de Asistencia para {new Date(aDetail.date).toLocaleDateString()}</h2>
                <Table>
                    <thead>
                    <tr>
                        <th>Usuario</th>
                    ...
                    {aDetail.attendanceRecords.map((userRecord, index) => (
                        ...
                        <td>{userRecord.checkInTime ? new Date(userRecord.checkInTime).toLocaleTimeString() : 'N/A'}</td>
                        </tr>
                    ))}
                    </tbody>
                </Table>
